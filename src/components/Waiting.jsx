...
function Waiting({ gameId, amount, address }) {
  ...
  const quotes = [
    ...
    {
      quote: "The beauty of chess is it can be whatever you want it to be. It transcends language, age, race, religion, politics, gender, and socioeconomic background. Whatever your circumstances, anyone can enjoy a good fight to the death over the chess board.",
    ...
    {
      quote: "Half the variations which are calculated in a tournament game turn out to be completely superfluous. Unfortunately, no one knows in advance which half.",
      author: "Jan Timman"
    },
    {
  ...
  return !joined ? (
    ...
    <div className="matchBg"
    style={{
      position: "relative",
      
      overflow: "hidden",
    }}>
    <Navbar head="Matchmaking" style={{position: "relative", top: "5rem"}}/>
    <div
          style={{
            display: "flex",
            position:"relative",
        ...
        >
          ...
          >
            ...
            >
            <input type="text" value={gameId} id="clip" style={{background: "transparent", border: "0px solid transparent", appearance: "none", width: "22rem" }}/>
